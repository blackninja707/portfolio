          ...
          <LoadAnimate amount={0}>
            <div className="z-20 mx-auto w-full text-center lg:w-3/4 xl:w-1/2">
              ...
              <p className="text-base leading-relaxed sm:text-lg">
                As the CEO, I highly recommend Thomas Ken as an exceptional senior full-stack developer who consistently
                delivers outstanding results and brings invaluable expertise to any project."
              </p>
              <span className="mb-2 mt-8 inline-block h-1 w-10 rounded bg-primary-700 dark:bg-yellow-300" />
              <h2 className="title-font text-sm font-medium tracking-wider">Panagiotis Drakatos</h2>
              <p className="text-neutral-400">Adrestus Founder & CEO</p>
            </div>
          </LoadAnimate>
        </div>
      </section>
